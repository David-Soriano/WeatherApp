                            ...
                            {days.map((day) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full flex items-center justify-between p-2 rounded-lg hover:bg-neutral-700 transition ${
                                            isSelected ? "bg-neutral-700 font-medium" : ""
                                        }`}
                                    >
                                        <span>{day}</span>
                                        {isSelected && (
                                            <img className="ml-2" src="/assets/images/icon-checkmark.svg"></img>
                                        )}
                                    </button>
                                );
                            })}
